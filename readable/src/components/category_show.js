...
import { fetchCategoryPosts, fetchCategories, openModal, closeModal, deletePost, votePost } from '../actions';
...
export default connect(mapStateToProps, { fetchCategoryPosts, fetchCategories, closeModal, openModal, deletePost, votePost })(CategoriesDetails)
